...
;;TESTE
    ...
    if right-color = blue and jogada != 1 [
      right 90
      fd 1
      set sleep-timer descansoLeao
    ]

    if ahead-color = blue and jogada != 1 [
      fd 1
      set sleep-timer descansoLeao
    ]
    ...
    ifelse sleep-timer > 0 [
      ...
      if left-color != black and jogada != 1 [
...
to move_hienas
  ask hienas [
    ...
    let left-hienas count hienas-on left-patch
...
;;TESTE
    ...
    if ahead-hienas > 0 [set group-level group-level + 1]
    ...
    if left-patch != nobody and ([pcolor] of left-patch != black) [
      ...
      if [pcolor] of left-patch = red [
        set energy energy + comidaPequenaEnergy
        ask left-patch [set pcolor black]
      ]
      left 90
      forward 1
      set found 1
    ...
    if right-patch != nobody and ([pcolor] of right-patch != black) [
      ...
      if [pcolor] of right-patch = red [
        set energy energy + comidaPequenaEnergy
        ask right-patch [set pcolor black]
      ]
      right 90
      forward 1
      set found 1
    ...
    if ahead-patch != nobody and ([pcolor] of ahead-patch != black) [
      ...
      if [pcolor] of ahead-patch = red [
        set energy energy + comidaPequenaEnergy
        ask ahead-patch [set pcolor black]
      ]
      forward 1
      set found 1
      set energy energy - 1
